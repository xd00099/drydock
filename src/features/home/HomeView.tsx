...
import type { SessionView, UsageOverview } from '@/lib/types'
import { fmtTokens, projectColor, sessionLabel } from '@/lib/types'
import RecapDigest from '@/features/home/RecapDigest'
...
const S = {
  ...
  card: { background: 'var(--dd-bg0)', border: '1px solid var(--dd-hairline)', borderRadius: 8, padding: '10px 12px' } as const,
