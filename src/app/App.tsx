...
import type { Artifact, RestoreTab, SessionView, Tab, TakeoverInfo } from '@/lib/types'
...
export default function App() {
  ...
  // Artifacts + the interactive review loop layered on them — see useArtifacts.
  const {
